...
# bridge = "Stop! Who would cross the Bridge of Death must answer these questions three, ere the other side he see."
...
while choice != 'quit':
    ...
    if choice.lower() == "forest":
        print("As you traverse this dense forest, you are stopped by the Knights of Ni. You appease the Knights of Ni "
           "by spending your money on shrubberies courtest of Roger the Shrubber. At least you didn't need to chop "
           "down the largest tree in the forest with a herring.")
        print("")
    elif choice.lower() == "camelot":
        print("You've done it. You've reached Camelot. This great castly (while it's on a model), is the most "
