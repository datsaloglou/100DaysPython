...
if lost:
    ...
    print("Celebrate by giving Andrian a kiss.")  
...
if prompt.lower() == "steps":
   ...
   print("{} is not acceptable entry.".format(prompt))

num = int(input("Select a positive number 1 and 10:"))
if num > 10:
    ...
    print("{} slides of beef? That's a good number to punch if you want to be the champ.".format(num))
elif num < 10:
...
if awards.lower() == 'won':
    ...
    if movie.lower() == 'rocky':
        ...
        print("Rocky received an Oscar nomination for Best Original Song")
    else:
